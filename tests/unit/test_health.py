...
class TestEventBusCheck:
    ...
    def test_event_bus_check_success(self, mock_event_bus_class):
        ...
        mock_event_bus._subscribers = {"event1": [lambda x: x], "event2": [lambda x: x, lambda x: x]}
...
class TestOverallHealthCheck:
    ...
    def test_health_check_event_bus_error(self, mock_event_bus_check, mock_db_check):
        ...
        # Setup mocks
        mock_db_check.return_value = {"status": "ok", "message": "DB ok"}
        mock_event_bus_check.return_value = {"status": "error", "message": "EventBus failed"}
    ...
    def test_health_check_includes_environment(self, mock_settings, mock_event_bus_check, mock_db_check):
